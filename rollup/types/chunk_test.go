...
func TestChunkHash(t *testing.T) {
	...
	hash, err = chunk.Hash(0)
	assert.NoError(t, err)
	assert.Equal(t, "0x014916a83eccdb0d01e814b4d4ab90eb9049ba9a3cb0994919b86ad873bcd028", hash.Hex())
	...
	hash, err = chunk.Hash(0)
	assert.NoError(t, err)
	assert.Equal(t, "0xadfbf1fc7226fe3839a4ea5f1ff802847396f33d3d682449cbbe86dab8b7053a", hash.Hex())
}
